...
/*
 * Cloned from nbbuild/antsrc/org/netbeans/nbbuild
 * Modified to accept the 'overrideManifest' parameter
 *
 */
 ...
 * @author Jesse Glick
 */
public class RaveLocalizedJar extends MatchingTask {
    ...
    private boolean overrideManifest = false;
    ...
    /** Override Manifest file for the JAR.
     * Default behavior is to ignore manifest argument if jar has locale or branding markings
     */
    public void setOverrideManifest (boolean overrideManifest) {
	this.overrideManifest = overrideManifest;
    }
            ...
            while (it.hasNext ()) {
                ...
                try {
                    ...
                    try {
                        ...
                        InputStream is;
                        long time;
                        if ((manifest != null && localeMark == null && brandingMark == null) || overrideManifest) {
