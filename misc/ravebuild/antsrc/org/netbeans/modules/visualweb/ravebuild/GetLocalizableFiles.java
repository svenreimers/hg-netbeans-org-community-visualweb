 ...
 */
public class GetLocalizableFiles extends Task {
  ...
  protected boolean moduleList = true ;
  protected String localizable_modules = "";
  ...
  public void setModuleList( boolean doit) {
    moduleList = doit ;
  }
  ...
  public void execute() throws BuildException {
    ...
    while( iter.hasNext()) {
      ...
      if (moduleList) {
        localizable_modules = module.getName() + "," + localizable_modules;
      }
    }
    getProject().setNewProperty("allmodules", localizable_modules);
  }
  ...
  protected class L9eMapper implements FileNameMapper {
    ...
    public String[] mapFileName(String file) {
      return new String[] { GetLocalizableFiles.mapL9eFile( file, m_toDir, m_grandParent) } ;
    }
  }
