...
public class PanelConfigureProjectVisual extends JPanel implements HelpCtx.Provider {
    ...
    void store(WizardDescriptor d) {
        ...
        d.putProperty(WizardProperties.SET_AS_MAIN, Boolean.TRUE);
        d.putProperty(WizardProperties.SERVER_INSTANCE_ID,
                      Deployment.getDefault().getDefaultServerInstanceID());
        d.putProperty(WizardProperties.SOURCE_STRUCTURE,
                      JsfProjectConstants.SRC_STRUCT_JAKARTA);
        d.putProperty(WizardProperties.J2EE_LEVEL,
                      J2eeModule.J2EE_14);
        d.putProperty(WizardProperties.CONTEXT_PATH,
                      "/" + projectLocationPanel.projectNameTextField. // NOI18N
                      getText().trim().replace(' ', '_')); // NOI18N
        d.putProperty(WizardProperties.EAR_APPLICATION, null);
